...
```bash
python scraper/fetch.py --mode tweet   --url <tweet_id_or_url>
python scraper/fetch.py --mode rss     --url https://www.gsqi.com/feed/
python scraper/fetch.py --mode page    --url https://example.com/post
python scraper/fetch.py --mode stealth --url https://cloudflared.example/post --timeout 60000
```
