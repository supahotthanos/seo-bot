...
export const RICH_ELIGIBLE = new Set(['LocalBusiness', 'MedicalBusiness', 'MedicalClinic', 'HealthAndBeautyBusiness', 'Dentist', 'Physician', 'Organization', 'Product', 'Offer', 'AggregateOffer', 'Review', 'AggregateRating', 'BreadcrumbList', 'Article', 'NewsArticle', 'BlogPosting', 'VideoObject', 'Event', 'Service', 'Person', 'WebSite', 'ImageObject', 'Recipe', 'JobPosting']);
export const DEPRECATED_RICH = new Set(['FAQPage', 'HowTo', 'QAPage']); // valid markup, but no longer render rich (May 2026)
...
export function typesFromHtml(html) {
